...
features_train, features_test, target_train, target_test = train_test_split(df_10m.iloc[:, 0:-6], df_10m[['ghi_kt_10min','ghi_clear_10min','ghi_10min']], test_size=0.2, shuffle=False)
