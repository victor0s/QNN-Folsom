...
features_train =  pd.read_csv("C:/Users/victo/Desktop/UoG/24Winter/Quantum Computing/Project/Codes_RFE/30min_80_20_dni/features_train.csv")
features_test = pd.read_csv("C:/Users/victo/Desktop/UoG/24Winter/Quantum Computing/Project/Codes_RFE/30min_80_20_dni/features_test.csv")
target_train =  pd.read_csv("C:/Users/victo/Desktop/UoG/24Winter/Quantum Computing/Project/Codes_RFE/30min_80_20_dni/target_train.csv")
target_test = pd.read_csv("C:/Users/victo/Desktop/UoG/24Winter/Quantum Computing/Project/Codes_RFE/30min_80_20_dni/target_test.csv")
...
tuning_model.fit(features_train.iloc[:,:], target_train.iloc[:,:]['dni_kt_30min'])
...
# xgboost_reg.fit(X_val_10m, y_val_10m['dni_kt_30min'])

# y_pred_val_XGB = xgboost_reg.predict(X_val_10m)

# val_XGB_error = calculate_errors(y_pred_val_XGB * y_val_10m['dni_clear_30min'].values, y_val_10m['dni_30min'].values, 1)

svr_model.fit(features_test, target_test['dni_kt_30min'])

y_pred_test_XGB = svr_model.predict(features_test)

test_XGB_error = calculate_errors(y_pred_test_XGB * target_test['dni_clear_30min'].values, target_test['dni_30min'].values, 1)
