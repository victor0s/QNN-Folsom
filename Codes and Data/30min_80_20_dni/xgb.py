...
# xgboost_reg.fit(X_val_30m, y_val_30m['ghi_kt_30min'])

# y_pred_val_XGB = xgboost_reg.predict(X_val_30m)

# val_XGB_error = calculate_errors(y_pred_val_XGB * y_val_30m['ghi_clear_30min'].values, y_val_30m['ghi_30min'].values, 1)

xgboost_reg.fit(features_test, target_test['ghi_kt_30min'])
