...
features_train =  pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/10min_80_20_dni/features_train.csv")
features_test = pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/10min_80_20_dni/features_test.csv")
target_train =  pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/10min_80_20_dni/target_train.csv")
target_test = pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/10min_80_20_dni/target_test.csv")
...
#X_train = np.array(features_train[['B(dni_kt|10min)', 'V(dni_kt|10min)', 'L(dni_kt|10min)']]).reshape(len(features_train), 3)
...
y_train = np.array(target_train['dni_kt_10min'])

X_test = np.array(features_test).reshape(len(features_test),  len(features_test.iloc[0]))
y_test = np.array(target_test['dni_kt_10min'])
...
VQR_hat_10min = VQR_hat_10min * target_test['dni_clear_10min']

test_VQR_error = calculate_errors(VQR_hat_10min.values, target_test['dni_10min'].values, 1)
