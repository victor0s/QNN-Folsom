...
features_train, features_test, target_train, target_test = train_test_split(df_30m.iloc[:, 0:-6], df_30m[['ghi_kt_30min','ghi_clear_30min','ghi_30min']], test_size=0.2, shuffle=False)
...
n_scores = cross_val_score(pipeline, features_train, target_train['ghi_kt_30min'],
...
#fitting the model
rfe.fit(features_train, target_train['ghi_kt_30min'])
