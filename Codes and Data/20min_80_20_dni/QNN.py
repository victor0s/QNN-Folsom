...
features_train =  pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/20min_80_20_dni/features_train.csv")
features_test = pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/20min_80_20_dni/features_test.csv")
target_train =  pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/20min_80_20_dni/target_train.csv")
target_test = pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/20min_80_20_dni/target_test.csv")
...
#X_train = np.array(features_train[['B(dni_kt|20min)', 'V(dni_kt|20min)', 'L(dni_kt|20min)']]).reshape(len(features_train), 3)
...
y_train = np.array(target_train['dni_kt_20min'])

X_test = np.array(features_test).reshape(len(features_test),  len(features_test.iloc[0]))
y_test = np.array(target_test['dni_kt_20min'])
...
regressor = NeuralNetworkRegressor(
    ...
    loss="squared_error",
    optimizer= L_BFGS_B(maxiter=10, ftol = 10E-5),
...
VQR_hat_20min = regressor.predict(X_test)
VQR_hat_20min = np.squeeze(VQR_hat_20min)

VQR_hat_20min = VQR_hat_20min * target_test['dni_clear_20min']

test_VQR_error = calculate_errors(VQR_hat_20min.values, target_test['dni_20min'].values, 1)
