...
features_train =  pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/5min_80_20_dni/features_train.csv")
features_test = pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/5min_80_20_dni/features_test.csv")
target_train =  pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/5min_80_20_dni/target_train.csv")
target_test = pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/5min_80_20_dni/target_test.csv")
...
tuning_model.fit(features_train.iloc[:,:], target_train.iloc[:,:]['dni_kt_5min'])
...
# xgboost_reg.fit(X_val_5m, y_val_5m['dni_kt_5min'])

# y_pred_val_XGB = xgboost_reg.predict(X_val_5m)

# val_XGB_error = calculate_errors(y_pred_val_XGB * y_val_5m['dni_clear_5min'].values, y_val_5m['dni_5min'].values, 1)

xgboost_reg.fit(features_test, target_test['dni_kt_5min'])

y_pred_test_XGB = xgboost_reg.predict(features_test)

test_XGB_error = calculate_errors(y_pred_test_XGB * target_test['dni_clear_5min'].values, target_test['dni_5min'].values, 1)
