...
features_train, features_test, target_train, target_test = train_test_split(df_20m.iloc[:, 0:-6], df_20m[['ghi_kt_20min','ghi_clear_20min','ghi_20min']], test_size=0.2, shuffle=False)
...
n_scores = cross_val_score(pipeline, features_train, target_train['ghi_kt_20min'],
...
#fitting the model
rfe.fit(features_train, target_train['ghi_kt_20min'])
