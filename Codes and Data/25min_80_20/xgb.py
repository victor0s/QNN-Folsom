...
features_train =  pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/25min_80_20/features_train.csv")
features_test = pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/25min_80_20/features_test.csv")
target_train =  pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/25min_80_20/target_train.csv")
target_test = pd.read_csv("C:/Users/volive04/Desktop/UoG/24WINTER/Quantum Computing/Project/Codes_RFE/25min_80_20/target_test.csv")
...
tuning_model.fit(features_train.iloc[:,:], target_train.iloc[:,:]['ghi_kt_25min'])
...
# xgboost_reg.fit(X_val_25m, y_val_25m['ghi_kt_25min'])

# y_pred_val_XGB = xgboost_reg.predict(X_val_25m)

# val_XGB_error = calculate_errors(y_pred_val_XGB * y_val_25m['ghi_clear_25min'].values, y_val_25m['ghi_25min'].values, 1)

xgboost_reg.fit(features_test, target_test['ghi_kt_25min'])

y_pred_test_XGB = xgboost_reg.predict(features_test)

test_XGB_error = calculate_errors(y_pred_test_XGB * target_test['ghi_clear_25min'].values, target_test['ghi_25min'].values, 1)
