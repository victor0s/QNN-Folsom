...
features_train =  pd.read_csv("C:/Users/victo/Desktop/UoG/24Winter/Quantum Computing/Project/Codes_RFE/25min_80_20/features_train.csv")
features_test = pd.read_csv("C:/Users/victo/Desktop/UoG/24Winter/Quantum Computing/Project/Codes_RFE/25min_80_20/features_test.csv")
target_train =  pd.read_csv("C:/Users/victo/Desktop/UoG/24Winter/Quantum Computing/Project/Codes_RFE/25min_80_20/target_train.csv")
target_test = pd.read_csv("C:/Users/victo/Desktop/UoG/24Winter/Quantum Computing/Project/Codes_RFE/25min_80_20/target_test.csv")
...
# xgboost_reg.fit(X_val_10m, y_val_10m['ghi_kt_25min'])

# y_pred_val_XGB = xgboost_reg.predict(X_val_10m)

# val_XGB_error = calculate_errors(y_pred_val_XGB * y_val_10m['ghi_clear_25min'].values, y_val_10m['ghi_25min'].values, 1)

svr_model.fit(features_test, target_test['ghi_kt_25min'])
